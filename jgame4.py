...
def still_free(game_array):
    ...
    #horizontal
    if a1_player == a2_player and a1_value == False:
        if a3_value == True:
            empty_array2.append('a3')
    if a1_player == a3_player and a1_value == False:
        if a2_value == True:
            empty_array2.append('a2')
    if a2_player == a3_player and a2_value == False:
        if a1_value == True:
            empty_array2.append('a1')
    
    if b1_player == b2_player and b1_value == False:
        if b3_value == True:
            empty_array2.append('b3')
    if b1_player ==b3_player and b1_value == False:
        if b2_value == True:
            empty_array2.append('b2')
    if b2_player == b3_player and b2_value == False:
        if b1_value == True:
            empty_array2.append('b1')
    
    if c1_player == c2_player and c1_value == False:
        if c3_value == True:
            empty_array2.append('c3')
    if c1_player == c3_player and c1_value == False :
        if c2_value == True:
            empty_array2.append('c2')
    if c2_player == c3_player and c2_value == False:
        if c1_value == True:
            empty_array2.append('c1')
    
    #vertikal
    
    if a1_player == b1_player and a1_value == False:
        if c1_value == True:
            empty_array2.append('c1')
    if a1_player == c1_player and a1_value == False:
        if b1_value == True:
            empty_array2.append('b1')
    if b1_player == c1_player and b1_value == False:
        if a1_value == True:
            empty_array2.append('a1')
    
    if a2_player == b2_player and a2_value == False:
        if c2_value == True:
            empty_array2.append('c2')
    if a2_player == c2_player and a2_value == False:
        if b2_value == True:
            empty_array2.append('b2')
    if b2_player == c2_player and b2_value == False:
        if a2_value == True:
            empty_array2.append('a2')
    
    if a3_player == b3_player and a3_value == False:
        if c3_value == True:
            empty_array2.append('c3')
    if a3_player == c3_player and a3_value == False:
        if b3_value == True:
            empty_array2.append('b3')
    if b3_player == c3_player and b3_value == False:
        if a3_value == True:
            empty_array2.append('a3')
    
    #diagonal
    
    if a1_player == b2_player and a1_value == False:
        if c3_value == True:
            empty_array2.append('c3')
    if a1_player == c3_player and a1_value == False:
        if b2_value == True:
            empty_array2.append('b2')
    if b2_player == c3_player and b2_value == False:
        if a1_value == True:
            empty_array2.append('a1')
    
    if c1_player == b2_player and c1_value == False:
        if a3_value == True:
            empty_array2.append('a3')
    if c1_player == a3_player and c1_value == False:
        if b2_value == True:
            empty_array2.append('b2')
    if b2_player == a3_player and b2_value == False:
        if c1_value == True:
            empty_array2.append('c1')
